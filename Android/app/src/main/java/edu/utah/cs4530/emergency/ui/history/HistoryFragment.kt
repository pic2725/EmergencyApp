...
class HistoryFragment: LiveModelFragment<HistoryViewModel>(HistoryViewModel::class, R.layout.fragment_history)
{
    ...
    override fun onCreateViewModel(
        ...
        viewModel.histories.observe(this, Observer {
            root.historyRecyclerView.adapter = HistoryAdaptor(it)
        })
    }
}